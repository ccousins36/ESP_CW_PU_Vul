...
# plt.scatter(VJDs, Vmagnitudes, facecolors='orange', edgecolors="orange", s=15, label="V")
# # plt.errorbar(VJDs, Vmagnitudes, Vmag_unc, ls="none", c="orange")
# plt.xlabel("JD")
...
x_axis_obs_offset=2253.5+5000-750+100-60-2500-100+20-8+2+2000+700-100+20+5
...
for i in range(0, len(all_arr_x)):
	if all_arr_x[i] > 13275 and all_arr_x[i] < 13290:
...
chisq=np.sum(fit_for_chisq-fit_mesa_for_chisq) / len(list_fit_mesa_for_chisq)
print(chisq)

plt.plot(all_arr_x_filtered,fit_mesa_for_chisq, c="red", zorder=10)
#plt.show()
plt.savefig("luminosity_with_obs.pdf")
